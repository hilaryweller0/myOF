...
for num in 3 4 5 6 7; do
    for ref in 2 4; do
        ...
        # link with the mesh
        ln -s ../../../../../../meshes/sphereMeshes/MongeKantorovich/$case/0/polyMesh \
              $case/constant/polyMesh
        ln -s ../../../../../../../meshes/sphereMeshes/MongeKantorovich/$case/0/dualMesh/polyMesh \
              $case/constant/dualMesh/polyMesh
        ln -s ../../../../../meshes/sphereMeshes/MongeKantorovich/$case/orthogLog $case/orthogLog
